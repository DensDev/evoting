    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url('peserta/balon/chart_balon')?>"><i class="fa fa-bar-chart"></i> Hasil Voting Bakal Calon Ketua</a></li>
            <li><a href="<?php echo base_url('peserta/calon/chart_calon')?>"><i class="fa fa-bar-chart"></i> Hasil Voting Calon Ketua</a></li>
          </ul>
        </li>
        <!-- end menu user -->
        <!-- menu user -->

  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Hapus Data Peserta & Peninjau</h4>
      </div>
      ...
      <div class="modal-footer">
        ...
        <a href="<?php echo base_url('admin/user/delete/'.$users->id_user)?>" class="btn btn-danger"><i class="fa fa-trash-o"></i> Delete</a>
      </div>
    </div>
    <!-- /.modal-content -->
  </div>
